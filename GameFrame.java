...
public class GameFrame extends JFrame
{
    ...
    private void tileClicked(ActionEvent e, JButton easy, JButton intermediate, JButton difficult)
    {
        ...
        if(index == bombLocation) {
            ...
            gameLost(easy, intermediate, difficult);
        }
        else 
        {
            ...
            if(score == winningScore) {
                gameWon(easy, intermediate, difficult);
            }
        }
    }
    ...
    private void gameLost(JButton easy, JButton intermediate, JButton difficult)
    {
        resetDifficulties(easy, intermediate, difficult);
        statusLabel.setText("You lost lol get rekt");
        setTextColor(statusLabel);
        setTilesStatus(false, Color.BLACK);
    }

    private void gameWon(JButton easy, JButton intermediate, JButton difficult)
    {
        resetDifficulties(easy, intermediate, difficult);
        statusLabel.setText("You won gg ez");
        setTextColor(statusLabel);
        setTilesStatus(false, Color.BLACK);
    }
